...
(library Library_1
	...
	(patternDef "HSMFC118" (originalName "HSMFC118")
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.6 1.35) (pt 1.6 1.35) (width 0.2))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.6 1.35) (pt 1.6 -1.35) (width 0.2))
		)
	...
	(symbolDef "HSMF-C118" (originalName "HSMF-C118")
		...
		(pin (pinNum 2) (pt 2000 mils 0 mils) (rotation 180) (pinLength 200 mils) (pinDisplay (dispPinName true)) (pinName (text (pt 1770 mils -25 mils) (rotation 0]) (justify "Right") (textStyleRef "Default"))
		))
	...
	(compDef "HSMF-C118" (originalName "HSMF-C118") (compHeader (numPins 4) (numParts 1) (refDesPrefix LED)
		...
		(compPin "1" (pinName "COMMON ANODE") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "RED CATHODE") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "GREEN CATHODE") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "BLUE CATHODE") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://componentsearchengine.com/Datasheets/2/HSMF-C118.pdf")
		(attr "Height" "1 mm")
	)
